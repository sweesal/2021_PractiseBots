...
public class DriveTrainC {

    private final DcMotor leftFront = RobotMapBotC.leftFront;
    private final DcMotor leftRear = RobotMapBotC.leftRear;
    private final DcMotor rightFront = RobotMapBotC.rightFront;
    private final DcMotor rightRear = RobotMapBotC.rightRear;
